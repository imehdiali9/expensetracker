      ...
      <div className="relative z-10 min-h-full flex items-center justify-center px-4 py-8">
        <div className="w-full max-w-[400px]">
          ...
          <div className="bg-[#0f1930]/80 backdrop-blur-2xl p-6 sm:p-8 rounded-[2rem] border border-[#69f6b8]/20 shadow-[0_0_50px_rgba(105,246,184,0.1)] hover:shadow-[0_0_60px_rgba(105,246,184,0.15)] transition-shadow duration-500 relative overflow-hidden group">
            ...
            <h2 className="font-headline text-xl font-bold text-white mb-5 drop-shadow-md">Create Your Account</h2>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="space-y-1.5">
                <label htmlFor="name" className="font-label text-[11px] font-semibold text-[#a3aac4] uppercase tracking-wider block">Full Name</label>
              ...
              <div className="space-y-1.5">
                <label htmlFor="email" className="font-label text-[11px] font-semibold text-[#a3aac4] uppercase tracking-wider block">Email Address</label>
              ...
              <div className="space-y-1.5">
                <label htmlFor="password" className="font-label text-[11px] font-semibold text-[#a3aac4] uppercase tracking-wider block">Password</label>
              ...
              <div className="space-y-1.5">
                <label htmlFor="confirm" className="font-label text-[11px] font-semibold text-[#a3aac4] uppercase tracking-wider block">Confirm Password</label>
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-[#a3aac4]">
              ...
              <Link to="/login" className="text-[#69f6b8] font-bold hover:underline ml-1">Sign In</Link>
            </p>
          </div>
